    ...
    public partial class frmCadastroFormaPagamento : Form
    {
        ...
        private void btSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                BLLFormaPagamento dal = new BLLFormaPagamento(cx);
                ...
                {
                    modelo.FormaPagamentoId = int.Parse(txtID.Text);
                    dal.Alterar(modelo);
        ...
        private void frmCadastroFormaPagamento_KeyDown(object sender, KeyEventArgs e)
        {
