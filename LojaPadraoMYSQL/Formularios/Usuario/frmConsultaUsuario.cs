...
namespace LojaPadraoMYSQL.Formularios
{
    public partial class frmConsultaUsuario : Form
    {
        ...
        {
            frmSenhaAdm senha = new frmSenhaAdm();
            senha.ShowDialog();
            ...
            else
            {
                ...
                ModeloUsuario modelo = bll.CarregaModeloUsuario(id);
                frmCadastroUsuario f = new frmCadastroUsuario(modelo);
                this.Opacity = 0;
                f.ShowDialog();
                this.Opacity = 1;
                f.Dispose();
        ...
        private void frmConsultaUsuario_KeyUp(object sender, KeyEventArgs e)
        {
