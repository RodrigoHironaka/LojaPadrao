...
namespace LojaPadraoMYSQL.Formularios
{
    public partial class frmConsultaUnidadeMedida : Form
    {
        public void AtualizaCabecalhoGridItens()
        {
            ...
            dgvDados.Columns[2].HeaderText = "SIGLA";
        ...
        private void frmConsultaUnidadeMedida_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frmConsultaUnidadeMedida_KeyUp(object sender, KeyEventArgs e)
        {
