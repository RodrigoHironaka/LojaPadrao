...
{
    public partial class frmConsultaFuncao : Form
    {
        public void AtualizaCabecalhoGridDados()
        {
            dgvDados.Columns[0].HeaderText = "Cod";
            dgvDados.Columns[1].HeaderText = "Função";
        ...
        private void btEdt_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ModeloFuncao modelo = bll.CarregaModeloFuncao(id);
                frmCadastroFuncao f = new frmCadastroFuncao(modelo);
                f.ShowDialog();
                f.Dispose();
                dgvDados.DataSource = bll.CarregaGridAtivo();
                cbStatus.SelectedIndex = 1;
        ...
        private void frmConsultaFuncao_Load(object sender, EventArgs e)
        {
            DALConexao cx = new DALConexao(DadosDaConexao.StringDeConexao);
            BLLFuncao bll = new BLLFuncao(cx);
            dgvDados.DataSource = bll.CarregaGridAtivo();
        ...
        private void frmConsultaFuncao_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frmConsultaFuncao_KeyUp(object sender, KeyEventArgs e)
        {
